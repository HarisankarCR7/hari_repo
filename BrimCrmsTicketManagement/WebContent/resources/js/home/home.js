...
"TAT"
    ...
    render: (data, td, dataIndex, cellIndex) => "<a href='complaintdetails?complId="+encodeURIComponent(data[0].data)+"' class='btn btn-primary' role='button'>Ticket Details</a>"
    }/*,
     {
      select: 13,
...
cafArray.push({
	...
	"id": e.id,
"username":e.username,
"Ticket Number" : e.ticketNo != null ? e.ticketNo : 'BR' + e.id,
"role": e.role,
"lob" : e.lob,
"bp": e.bp,
"loginTime":e.loginTIme,
"probTypeName" : e.probTypeName,
"subTypeName" : e.subTypeName,
"mac" : e.mac,
"description": e.description,
"Updated On" : e.updatedOn,
"Ticket Status" : e.status,
"Closed By" :   e.closedBy != null ? e.closedBy : '',
"Closed On" : e.closedOn != null ? e.closedOn : '',
"Closed Remarks" : e.closedRemarks != null ? e.closedRemarks : '',
"TAT" : e.tat != null ? e.tat : '',
...
rows.remove(parseInt($(this).attr("data-index")));
  ...
  $.ajax({
						...
						var response = JSON.parse(data)
							...
							buildDropdown(response, $('#rdropdown'),
									'Select an option');
...
cafArray.push({
	...
	"id": e.id,
"username":e.username,
"Ticket Number" : e.ticketNo != null ? e.ticketNo : '',
"role": e.role,
"lob" : e.lob,
"bp": e.bp,
"loginTime":e.loginTIme,
