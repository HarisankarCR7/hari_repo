...
<form class="form-inline" action="#" style=" padding: 40px 40px 30px !important;
            background: #ebeff2;"> 
      <div>   
    <label for="text">autoId</label> 
    <input type="text" class="form-control" id="email" value="<%= session.getAttribute("region") %>">  
    ...
    <label for="text">problemDescription</label> 
    <input type="text" class="form-control" id="password" value="<%= session.getAttribute("subCode") %>">  
   </div> <br><br>
   <div>   
    <label for="text">userName</label> 
    <input type="text" class="form-control" id="email" value="<%= session.getAttribute("CafNo") %>">
    <label for="text">userId</label> 
    <input type="text" class="form-control" id="email" >    
    <label for="text">fileName</label> 
     <input type="text" class="form-control" id="email" >
         <label for="text">loginTime</label> 
     <input type="text" class="form-control" id="email" >
     </div><br><br>
     <div>
              <label for="text">TicketNumber</label> 
               <input type="text" class="form-control" id="email" >
              <label for="text">crmTicketNo</label> 
               <input type="text" class="form-control" id="email" >
              <label for="text">lob</label>  
              <input type="text" class="form-control" id="email" >
              <label for="text">resolvedTime</label>  
              <input type="text" class="form-control" id="email" >
               </div><br><br>
              <div class="status">
       <label for="text">Status</label>  
      <select class="form-select form-select-lg mb-3" aria-label="Large select example" style="width:200px;height:35px;margin-left:5px;">
  <option selected>Select</option>
  <option value="esolved">Resolved</option>
